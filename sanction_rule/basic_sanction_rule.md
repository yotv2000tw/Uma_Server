...
{% tabs %}
{% tab title="解釋" %}
一、舉凡任何僅限付費觀賞，並未開放免費閱覽之內容，其影片、圖片、文字訊息，以及具有與前述內容直接相關之連結訊息，均依基本處分規章第九條第二項禁止討論，否則將予以禁言。前述限制不包含官方自行公開之相關內容。

1.

演唱會公開的遊戲情報、周邊情報，或其他與演唱會本質無直接相關的內容，在官方公開前，可以利用文字進行討論，但以音檔、圖檔與影檔之討論仍予以禁止。
{% endtab %}
{% endtabs %}
